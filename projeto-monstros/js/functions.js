...
const audioAlegria = new Audio('/projeto-monstros/audio/mikeAcerto.mp3');
const audioChoro = new Audio('/projeto-monstros/audio/mikeErro.mp3');
...
function main(){
    ...
    GRAVADOR.onresult = function (event){
        ...
        btnNext.addEventListener('click', function(){
            ...
            IMG_CONTAINER_DIREITA.setAttribute('src', '/projeto-monstros/img/banner.png' );
...
function setDivResult(acertouOuErrou){
    let srcImgAcertou = '/projeto-monstros/img/mikeAcertou.png' ;
    let srcImgErrou = '/projeto-monstros/img/booErrou.png';
